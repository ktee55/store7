# Generated by Django 3.1.8 on 2021-05-08 14:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_title', models.CharField(blank=True, help_text='リンク先のページタイトルとは別のリンク名を付けたい時のみ', max_length=50, null=True, verbose_name='Title(Option)')),
