  ...
  cards = blocks.ListBlock(
    blocks.StructBlock(
      [
        ...
        ("image_alt", blocks.CharBlock(required=False, max_length=100, help_text='Add some alt text', heading="Image Alt (Option)")),
...
class LinkStructValue(blocks.StructValue):
  ...
  ## Just as an example (it doesn't work here)
  # def latet_posts(self):
